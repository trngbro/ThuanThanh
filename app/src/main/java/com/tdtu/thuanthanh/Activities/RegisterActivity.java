...
import static com.tdtu.thuanthanh.R.*;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IMG_signup_back = findViewById(id.img_signup_back);
        BTN_signup_next = findViewById(id.btn_signup_next);
        TXT_signup_title = findViewById(id.txt_signup_title);
        TXTL_signup_HoVaTen = findViewById(id.txtl_signup_HoVaTen);
        TXTL_signup_TenDN = findViewById(id.txtl_signup_TenDN);
        TXTL_signup_Email = findViewById(id.txtl_signup_Email);
        TXTL_signup_SDT = findViewById(id.txtl_signup_SDT);
        TXTL_signup_MatKhau = findViewById(id.txtl_signup_MatKhau);
        //endregion
        ...
        BTN_signup_next.setOnClickListener(v -> {
            ...
            String hoTen = Objects.requireNonNull(TXTL_signup_HoVaTen.getEditText()).getText().toString();
            String tenDN = Objects.requireNonNull(TXTL_signup_TenDN.getEditText()).getText().toString();
            String eMail = Objects.requireNonNull(TXTL_signup_Email.getEditText()).getText().toString();
            String sDT = Objects.requireNonNull(TXTL_signup_SDT.getEditText()).getText().toString();
            String matKhau = Objects.requireNonNull(TXTL_signup_MatKhau.getEditText()).getText().toString();
    ...
    private boolean validateFullName(){
        String val = Objects.requireNonNull(TXTL_signup_HoVaTen.getEditText()).getText().toString().trim();
    ...
    private boolean validateUserName(){
        String val = Objects.requireNonNull(TXTL_signup_TenDN.getEditText()).getText().toString().trim();
    ...
    private boolean validateEmail(){
        String val = Objects.requireNonNull(TXTL_signup_Email.getEditText()).getText().toString().trim();
    ...
    private boolean validatePhone(){
        String val = Objects.requireNonNull(TXTL_signup_SDT.getEditText()).getText().toString().trim();
    ...
    private boolean validatePassWord(){
        String val = Objects.requireNonNull(TXTL_signup_MatKhau.getEditText()).getText().toString().trim();
